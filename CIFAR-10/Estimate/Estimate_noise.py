...
from models_est import MNISTModel, CIFAR10Model, CIFAR100Model
from models_est import IMDBModel, LSTMModel
from models_est import NoiseEstimator
os.environ["CUDA_VISIBLE_DEVICES"] = "0"
...
if __name__ == "__main__":
    ...
    n_pair = None
    noise_pair = None
    dataset, loss, noise = 'cifar10', 'est_forward', 0.3
