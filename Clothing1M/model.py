...
# NOTE this implementation follows the architecture for ImageNet
__all__ = ['ResNetCIFAR', 'resnet_cifar18', 'resnet_cifar34', 'resnet_cifar50', 'resnet_cifar101',
           'resnet_cifar152', 'resnet_cifar18_pre']
